...
export async function pollLogin(qrsig, conf) {
  ...
  const baseUrl = `https://ssl.ptlogin2.qq.com/ptqrlogin?u1=${u1}&ptredirect=0&h=1&t=1&g=1&from_ui=1&ptlang=2052&action=${Math.random()}&js_ver=23111510&js_type=1&login_sig=&pt_uistyle=40&aid=${conf.appid}&daid=${conf.daid}&o1vId=&pt_js_version=v1.48.1`
